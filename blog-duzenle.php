   ...
   <div class="row">
    <div class="col-md-12">
      <form action="core.php" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="yazar_id" value="<?php echo $blog['yazar_id'] ?>">
        ...
        <button type="submit" class="btn btn-primary" name="kullaniciblogduzenle">Düzenle</button>
        <a class="btn btn-danger rounded-0" href="core.php?kullaniciblogsil=ok&id=<?=$blog['id']?>">Sil</a>

    ...
    <div class="col-md-12">
      <form action="../core.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="sifre" value="<?=$kullanici['sifre']?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <select class="form-control" aria-label="Default select example" name="yetki">
              <option value="0">Admin</option>
              <option value="1" selected>Kullanıcı</option>
          </select>
        </div>

        <button type="submit" class="btn btn-primary" name="admin-kullaniciduzenle">Düzenle</button>
